...
contract Words is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        return ITokenURI(uriContract).tokenURI(tokenId);
    }
    ...
    function modify(uint256 tokenId, string memory words, string memory author, string memory desc) public payable nonReentrant {
        require(ownerOf(tokenId) == _msgSender(), 'only NFT owner');
